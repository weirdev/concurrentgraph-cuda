...
void negative_prob_multiply_matrix_vector_cpu(float* matrix, float* in_vector, float* out_vector, uint outerdim, uint innerdim) {
...
void negative_prob_multiply_matrix_vector_gpu(float* matrix, float* in_vector, float* out_vector, uint outerdim, uint innerdim) {
